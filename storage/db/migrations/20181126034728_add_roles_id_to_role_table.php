...
class AddRolesIdToRoleTable extends AbstractMigration
{
    public function change()
    {
        /*         $table = $this->table('user_roles');
                ...
                $this->table('user_roles')->changeColumn('companies_id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'apps_id'])->update();
                $this->table('user_roles')->changeColumn('created_at', 'datetime', ['null' => false, 'after' => 'companies_id'])->update();
