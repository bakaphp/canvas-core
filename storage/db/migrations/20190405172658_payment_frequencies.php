...
class PaymentFrequencies extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('payment_frequencies', ['id' => false, 'primary_key' => ['id'], 'engine' => 'InnoDB', 'encoding' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci', 'comment' => '', 'row_format' => 'Dynamic']);
